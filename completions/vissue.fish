...
complete -c vissue -n "__fish_vissue_needs_command" -f -a "hud" -d 'Summonable palette. Default is rofi over the ready set (seat theme)'
...
complete -c vissue -n "__fish_vissue_using_subcommand hud" -l mode -d 'ready, list (all), claims, stale, or new' -r
...
complete -c vissue -n "__fish_vissue_using_subcommand hud" -l offline -d 'Never attach, never spawn serve; used by `--iced`'
complete -c vissue -n "__fish_vissue_using_subcommand hud" -l toggle -d 'Show or hide a running iced HUD, or dismiss a live rofi picker'
complete -c vissue -n "__fish_vissue_using_subcommand hud" -l show -d 'Show a running iced HUD'
complete -c vissue -n "__fish_vissue_using_subcommand hud" -l hide -d 'Hide a running iced HUD, or dismiss a live rofi picker'
complete -c vissue -n "__fish_vissue_using_subcommand hud" -l iced -d 'Use the iced overlay instead of rofi'
...
complete -c vissue -n "__fish_vissue_using_subcommand help; and not __fish_seen_subcommand_from create q list show update ready claim note claims fold agenda hygiene whoami waiting-on body-excerpt search children ancestors impact related stale count export tree cycles graph refile backlinks roadmap check digest mirror events ping wait gen projects identity serve tui hud completions man help" -f -a "create" -d 'Create an issue. Pass the body with --body or --body-file (`-` reads stdin); omit both to leave the body empty for a later edit'
complete -c vissue -n "__fish_vissue_using_subcommand help; and not __fish_seen_subcommand_from create q list show update ready claim note claims fold agenda hygiene whoami waiting-on body-excerpt search children ancestors impact related stale count export tree cycles graph refile backlinks roadmap check digest mirror events ping wait gen projects identity serve tui hud completions man help" -f -a "q" -d 'Quick capture: create and print only the id'
complete -c vissue -n "__fish_vissue_using_subcommand help; and not __fish_seen_subcommand_from create q list show update ready claim note claims fold agenda hygiene whoami waiting-on body-excerpt search children ancestors impact related stale count export tree cycles graph refile backlinks roadmap check digest mirror events ping wait gen projects identity serve tui hud completions man help" -f -a "list" -d 'List issues, sorted by priority then state then id'
complete -c vissue -n "__fish_vissue_using_subcommand help; and not __fish_seen_subcommand_from create q list show update ready claim note claims fold agenda hygiene whoami waiting-on body-excerpt search children ancestors impact related stale count export tree cycles graph refile backlinks roadmap check digest mirror events ping wait gen projects identity serve tui hud completions man help" -f -a "show" -d 'Show one issue\'s metadata and file range'
complete -c vissue -n "__fish_vissue_using_subcommand help; and not __fish_seen_subcommand_from create q list show update ready claim note claims fold agenda hygiene whoami waiting-on body-excerpt search children ancestors impact related stale count export tree cycles graph refile backlinks roadmap check digest mirror events ping wait gen projects identity serve tui hud completions man help" -f -a "update" -d 'Update state, priority, or blocker edges'
complete -c vissue -n "__fish_vissue_using_subcommand help; and not __fish_seen_subcommand_from create q list show update ready claim note claims fold agenda hygiene whoami waiting-on body-excerpt search children ancestors impact related stale count export tree cycles graph refile backlinks roadmap check digest mirror events ping wait gen projects identity serve tui hud completions man help" -f -a "ready" -d 'Actionable issues: TODO or STARTED with no open blocker'
complete -c vissue -n "__fish_vissue_using_subcommand help; and not __fish_seen_subcommand_from create q list show update ready claim note claims fold agenda hygiene whoami waiting-on body-excerpt search children ancestors impact related stale count export tree cycles graph refile backlinks roadmap check digest mirror events ping wait gen projects identity serve tui hud completions man help" -f -a "claim" -d 'Take an issue: move it to STARTED and stamp the claim'
complete -c vissue -n "__fish_vissue_using_subcommand help; and not __fish_seen_subcommand_from create q list show update ready claim note claims fold agenda hygiene whoami waiting-on body-excerpt search children ancestors impact related stale count export tree cycles graph refile backlinks roadmap check digest mirror events ping wait gen projects identity serve tui hud completions man help" -f -a "note" -d 'Add a dated note to the top of an issue\'s logbook; state and claim untouched'
complete -c vissue -n "__fish_vissue_using_subcommand help; and not __fish_seen_subcommand_from create q list show update ready claim note claims fold agenda hygiene whoami waiting-on body-excerpt search children ancestors impact related stale count export tree cycles graph refile backlinks roadmap check digest mirror events ping wait gen projects identity serve tui hud completions man help" -f -a "claims" -d 'Every live claim, oldest first: who holds what, and for how long'
complete -c vissue -n "__fish_vissue_using_subcommand help; and not __fish_seen_subcommand_from create q list show update ready claim note claims fold agenda hygiene whoami waiting-on body-excerpt search children ancestors impact related stale count export tree cycles graph refile backlinks roadmap check digest mirror events ping wait gen projects identity serve tui hud completions man help" -f -a "fold" -d 'Fold an inbox org file: each unstamped `* TODO <title>` heading becomes an issue, then the heading is stamped with the id and flipped to DONE in place. Already-stamped headings are skipped'
complete -c vissue -n "__fish_vissue_using_subcommand help; and not __fish_seen_subcommand_from create q list show update ready claim note claims fold agenda hygiene whoami waiting-on body-excerpt search children ancestors impact related stale count export tree cycles graph refile backlinks roadmap check digest mirror events ping wait gen projects identity serve tui hud completions man help" -f -a "agenda" -d 'Dated open work: deadlines and scheduled starts inside a horizon, overdue first'
complete -c vissue -n "__fish_vissue_using_subcommand help; and not __fish_seen_subcommand_from create q list show update ready claim note claims fold agenda hygiene whoami waiting-on body-excerpt search children ancestors impact related stale count export tree cycles graph refile backlinks roadmap check digest mirror events ping wait gen projects identity serve tui hud completions man help" -f -a "hygiene" -d 'Checklist for agents and CI: stalled claims plus corpus validation'
complete -c vissue -n "__fish_vissue_using_subcommand help; and not __fish_seen_subcommand_from create q list show update ready claim note claims fold agenda hygiene whoami waiting-on body-excerpt search children ancestors impact related stale count export tree cycles graph refile backlinks roadmap check digest mirror events ping wait gen projects identity serve tui hud completions man help" -f -a "whoami" -d 'Print the identity this tracker would record on a claim'
complete -c vissue -n "__fish_vissue_using_subcommand help; and not __fish_seen_subcommand_from create q list show update ready claim note claims fold agenda hygiene whoami waiting-on body-excerpt search children ancestors impact related stale count export tree cycles graph refile backlinks roadmap check digest mirror events ping wait gen projects identity serve tui hud completions man help" -f -a "waiting-on" -d 'Issues waiting on this one'
complete -c vissue -n "__fish_vissue_using_subcommand help; and not __fish_seen_subcommand_from create q list show update ready claim note claims fold agenda hygiene whoami waiting-on body-excerpt search children ancestors impact related stale count export tree cycles graph refile backlinks roadmap check digest mirror events ping wait gen projects identity serve tui hud completions man help" -f -a "body-excerpt" -d 'The first lines of an issue\'s file range'
complete -c vissue -n "__fish_vissue_using_subcommand help; and not __fish_seen_subcommand_from create q list show update ready claim note claims fold agenda hygiene whoami waiting-on body-excerpt search children ancestors impact related stale count export tree cycles graph refile backlinks roadmap check digest mirror events ping wait gen projects identity serve tui hud completions man help" -f -a "search" -d 'Substring search over ids, titles, properties, and bodies'
complete -c vissue -n "__fish_vissue_using_subcommand help; and not __fish_seen_subcommand_from create q list show update ready claim note claims fold agenda hygiene whoami waiting-on body-excerpt search children ancestors impact related stale count export tree cycles graph refile backlinks roadmap check digest mirror events ping wait gen projects identity serve tui hud completions man help" -f -a "children" -d 'Issues whose `:PARENT:` matches this id'
complete -c vissue -n "__fish_vissue_using_subcommand help; and not __fish_seen_subcommand_from create q list show update ready claim note claims fold agenda hygiene whoami waiting-on body-excerpt search children ancestors impact related stale count export tree cycles graph refile backlinks roadmap check digest mirror events ping wait gen projects identity serve tui hud completions man help" -f -a "ancestors" -d 'Blockers transitively required by this issue'
complete -c vissue -n "__fish_vissue_using_subcommand help; and not __fish_seen_subcommand_from create q list show update ready claim note claims fold agenda hygiene whoami waiting-on body-excerpt search children ancestors impact related stale count export tree cycles graph refile backlinks roadmap check digest mirror events ping wait gen projects identity serve tui hud completions man help" -f -a "impact" -d 'Issues transitively waiting on this issue'
complete -c vissue -n "__fish_vissue_using_subcommand help; and not __fish_seen_subcommand_from create q list show update ready claim note claims fold agenda hygiene whoami waiting-on body-excerpt search children ancestors impact related stale count export tree cycles graph refile backlinks roadmap check digest mirror events ping wait gen projects identity serve tui hud completions man help" -f -a "related" -d 'Explain bounded Org and lexical connections around an issue'
complete -c vissue -n "__fish_vissue_using_subcommand help; and not __fish_seen_subcommand_from create q list show update ready claim note claims fold agenda hygiene whoami waiting-on body-excerpt search children ancestors impact related stale count export tree cycles graph refile backlinks roadmap check digest mirror events ping wait gen projects identity serve tui hud completions man help" -f -a "stale" -d 'Open issues whose `:CREATED:` is older than N days'
complete -c vissue -n "__fish_vissue_using_subcommand help; and not __fish_seen_subcommand_from create q list show update ready claim note claims fold agenda hygiene whoami waiting-on body-excerpt search children ancestors impact related stale count export tree cycles graph refile backlinks roadmap check digest mirror events ping wait gen projects identity serve tui hud completions man help" -f -a "count" -d 'Print only the matching issue count'
complete -c vissue -n "__fish_vissue_using_subcommand help; and not __fish_seen_subcommand_from create q list show update ready claim note claims fold agenda hygiene whoami waiting-on body-excerpt search children ancestors impact related stale count export tree cycles graph refile backlinks roadmap check digest mirror events ping wait gen projects identity serve tui hud completions man help" -f -a "export" -d 'One JSON object per issue per line'
complete -c vissue -n "__fish_vissue_using_subcommand help; and not __fish_seen_subcommand_from create q list show update ready claim note claims fold agenda hygiene whoami waiting-on body-excerpt search children ancestors impact related stale count export tree cycles graph refile backlinks roadmap check digest mirror events ping wait gen projects identity serve tui hud completions man help" -f -a "tree" -d 'Children and blockers below an id'
complete -c vissue -n "__fish_vissue_using_subcommand help; and not __fish_seen_subcommand_from create q list show update ready claim note claims fold agenda hygiene whoami waiting-on body-excerpt search children ancestors impact related stale count export tree cycles graph refile backlinks roadmap check digest mirror events ping wait gen projects identity serve tui hud completions man help" -f -a "cycles" -d 'Cycles in the blocker graph'
complete -c vissue -n "__fish_vissue_using_subcommand help; and not __fish_seen_subcommand_from create q list show update ready claim note claims fold agenda hygiene whoami waiting-on body-excerpt search children ancestors impact related stale count export tree cycles graph refile backlinks roadmap check digest mirror events ping wait gen projects identity serve tui hud completions man help" -f -a "graph" -d 'The blocker and parent graph as Graphviz DOT'
complete -c vissue -n "__fish_vissue_using_subcommand help; and not __fish_seen_subcommand_from create q list show update ready claim note claims fold agenda hygiene whoami waiting-on body-excerpt search children ancestors impact related stale count export tree cycles graph refile backlinks roadmap check digest mirror events ping wait gen projects identity serve tui hud completions man help" -f -a "refile" -d 'Move an issue to another project\'s file'
complete -c vissue -n "__fish_vissue_using_subcommand help; and not __fish_seen_subcommand_from create q list show update ready claim note claims fold agenda hygiene whoami waiting-on body-excerpt search children ancestors impact related stale count export tree cycles graph refile backlinks roadmap check digest mirror events ping wait gen projects identity serve tui hud completions man help" -f -a "backlinks" -d 'Issues referring to this id'
complete -c vissue -n "__fish_vissue_using_subcommand help; and not __fish_seen_subcommand_from create q list show update ready claim note claims fold agenda hygiene whoami waiting-on body-excerpt search children ancestors impact related stale count export tree cycles graph refile backlinks roadmap check digest mirror events ping wait gen projects identity serve tui hud completions man help" -f -a "roadmap" -d 'A markdown roadmap of active and closed work'
complete -c vissue -n "__fish_vissue_using_subcommand help; and not __fish_seen_subcommand_from create q list show update ready claim note claims fold agenda hygiene whoami waiting-on body-excerpt search children ancestors impact related stale count export tree cycles graph refile backlinks roadmap check digest mirror events ping wait gen projects identity serve tui hud completions man help" -f -a "check" -d 'Validate the corpus. Exits non-zero on any error'
complete -c vissue -n "__fish_vissue_using_subcommand help; and not __fish_seen_subcommand_from create q list show update ready claim note claims fold agenda hygiene whoami waiting-on body-excerpt search children ancestors impact related stale count export tree cycles graph refile backlinks roadmap check digest mirror events ping wait gen projects identity serve tui hud completions man help" -f -a "digest" -d 'A content digest of the corpus, for telling whether a copy is current'
complete -c vissue -n "__fish_vissue_using_subcommand help; and not __fish_seen_subcommand_from create q list show update ready claim note claims fold agenda hygiene whoami waiting-on body-excerpt search children ancestors impact related stale count export tree cycles graph refile backlinks roadmap check digest mirror events ping wait gen projects identity serve tui hud completions man help" -f -a "mirror" -d 'Write a read-only projection of one or more projects to a file'
complete -c vissue -n "__fish_vissue_using_subcommand help; and not __fish_seen_subcommand_from create q list show update ready claim note claims fold agenda hygiene whoami waiting-on body-excerpt search children ancestors impact related stale count export tree cycles graph refile backlinks roadmap check digest mirror events ping wait gen projects identity serve tui hud completions man help" -f -a "events" -d 'Change events with a sequence above --since'
complete -c vissue -n "__fish_vissue_using_subcommand help; and not __fish_seen_subcommand_from create q list show update ready claim note claims fold agenda hygiene whoami waiting-on body-excerpt search children ancestors impact related stale count export tree cycles graph refile backlinks roadmap check digest mirror events ping wait gen projects identity serve tui hud completions man help" -f -a "ping" -d 'Append a manual event, waking pollers without editing an issue'
complete -c vissue -n "__fish_vissue_using_subcommand help; and not __fish_seen_subcommand_from create q list show update ready claim note claims fold agenda hygiene whoami waiting-on body-excerpt search children ancestors impact related stale count export tree cycles graph refile backlinks roadmap check digest mirror events ping wait gen projects identity serve tui hud completions man help" -f -a "wait" -d 'Block until the generation passes --last. Exits 2 on timeout'
complete -c vissue -n "__fish_vissue_using_subcommand help; and not __fish_seen_subcommand_from create q list show update ready claim note claims fold agenda hygiene whoami waiting-on body-excerpt search children ancestors impact related stale count export tree cycles graph refile backlinks roadmap check digest mirror events ping wait gen projects identity serve tui hud completions man help" -f -a "gen" -d 'Print the current generation counter'
complete -c vissue -n "__fish_vissue_using_subcommand help; and not __fish_seen_subcommand_from create q list show update ready claim note claims fold agenda hygiene whoami waiting-on body-excerpt search children ancestors impact related stale count export tree cycles graph refile backlinks roadmap check digest mirror events ping wait gen projects identity serve tui hud completions man help" -f -a "projects" -d 'List the projects found under the layout prefix'
complete -c vissue -n "__fish_vissue_using_subcommand help; and not __fish_seen_subcommand_from create q list show update ready claim note claims fold agenda hygiene whoami waiting-on body-excerpt search children ancestors impact related stale count export tree cycles graph refile backlinks roadmap check digest mirror events ping wait gen projects identity serve tui hud completions man help" -f -a "identity" -d 'Print the resolved binary, root, and prefix'
complete -c vissue -n "__fish_vissue_using_subcommand help; and not __fish_seen_subcommand_from create q list show update ready claim note claims fold agenda hygiene whoami waiting-on body-excerpt search children ancestors impact related stale count export tree cycles graph refile backlinks roadmap check digest mirror events ping wait gen projects identity serve tui hud completions man help" -f -a "serve" -d 'Own the per-user Unix control socket'
complete -c vissue -n "__fish_vissue_using_subcommand help; and not __fish_seen_subcommand_from create q list show update ready claim note claims fold agenda hygiene whoami waiting-on body-excerpt search children ancestors impact related stale count export tree cycles graph refile backlinks roadmap check digest mirror events ping wait gen projects identity serve tui hud completions man help" -f -a "tui" -d 'Interactive board over ready, list, claims, agenda, and search'
complete -c vissue -n "__fish_vissue_using_subcommand help; and not __fish_seen_subcommand_from create q list show update ready claim note claims fold agenda hygiene whoami waiting-on body-excerpt search children ancestors impact related stale count export tree cycles graph refile backlinks roadmap check digest mirror events ping wait gen projects identity serve tui hud completions man help" -f -a "hud" -d 'Summonable palette. Default is rofi over the ready set (seat theme)'
complete -c vissue -n "__fish_vissue_using_subcommand help; and not __fish_seen_subcommand_from create q list show update ready claim note claims fold agenda hygiene whoami waiting-on body-excerpt search children ancestors impact related stale count export tree cycles graph refile backlinks roadmap check digest mirror events ping wait gen projects identity serve tui hud completions man help" -f -a "completions" -d 'Write a shell completion script to stdout'
complete -c vissue -n "__fish_vissue_using_subcommand help; and not __fish_seen_subcommand_from create q list show update ready claim note claims fold agenda hygiene whoami waiting-on body-excerpt search children ancestors impact related stale count export tree cycles graph refile backlinks roadmap check digest mirror events ping wait gen projects identity serve tui hud completions man help" -f -a "man" -d 'Write the roff manual page to stdout'
complete -c vissue -n "__fish_vissue_using_subcommand help; and not __fish_seen_subcommand_from create q list show update ready claim note claims fold agenda hygiene whoami waiting-on body-excerpt search children ancestors impact related stale count export tree cycles graph refile backlinks roadmap check digest mirror events ping wait gen projects identity serve tui hud completions man help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
