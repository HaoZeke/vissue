...
complete -c vissue -n "__fish_vissue_needs_command" -f -a "hud" -d 'Exec `vissue-hud` (PATH or VISSUE_HUD_BIN). Does not compile it'
...
complete -c vissue -n "__fish_vissue_using_subcommand hud" -l offline -d 'Never attach, never spawn serve; CatalogService plus generation poll'
complete -c vissue -n "__fish_vissue_using_subcommand hud" -l toggle -d 'Show or hide a running HUD'
complete -c vissue -n "__fish_vissue_using_subcommand hud" -l show -d 'Show a running HUD'
complete -c vissue -n "__fish_vissue_using_subcommand hud" -l hide -d 'Hide a running HUD'
...
complete -c vissue -n "__fish_vissue_using_subcommand help; and not __fish_seen_subcommand_from create q list show update ready claim note claims fold agenda hygiene whoami waiting-on body-excerpt search children ancestors impact related stale count export tree cycles graph refile backlinks roadmap check digest mirror events ping wait gen projects identity serve tui hud completions man help" -f -a "hud" -d 'Exec `vissue-hud` (PATH or VISSUE_HUD_BIN). Does not compile it'
