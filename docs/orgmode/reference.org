...
=vissue hud= is the terminal board in a window (Ready / List / Claims /
Agenda / Search, plus a detail card).
...
=vissue_related=, =vissue_waiting_on=, =vissue_body_excerpt=, =vissue_org=,
=vissue_append=, =vissue_tree=,
